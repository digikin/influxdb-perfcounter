...
2. Click on the Setup instructions to find your Token<br />
 (Example "export INFLUX_TOKEN=xXXXXxxXXXXxxxxXXxxXxXXXXxxXXxXXXXXxXXXXXxXXXxXXxXXXXXXXxxxXxXXxxX-XxxxXXXxxXXxXX==")<br />
3. In the powershell terminal issue the command: $INFLUX_TOKEN = "{only what is after the equal sign in your token}"
4. To test if telefraf can connect issue the command inside the foler telegraf is located: .\telegraf --config telegraf.conf --test
**If you get something like this in the terminal you are transmitting data to influx2.0 successfully**
```
